...
class NeuralNet(nn.Module):
    def __init__(self, lrate, loss_fn, in_size, out_size):
        ...
        # optimization
        self.op1 = optim.SGD(self.model.parameters(),lr=lrate, momentum=0.9)  
...
def fit(train_set,train_labels,dev_set,epochs,batch_size=100):
    ...
    N1 = NeuralNet(lrate = 0.01, loss_fn = nn.CrossEntropyLoss(), in_size = 3072, out_size = 4)
    ...
    for i in range(epochs):
        ...
        for batch_map in train_dataloader:
            ...
            curr_loss += N1.step(data_batch, label_batch)
